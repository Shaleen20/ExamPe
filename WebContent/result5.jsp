...
<body style="background-color: #DAE0E2;">
  ...
  <div class="container my-4">
    <nav class="navbar navbar-light bg-dark">
      ...
      <a href="/loginPage.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Log out</a>
    </nav>
  </div>
<div class="container my-4">
        ...
        <div class="col-sm-6">
            <div class="card text-center text-white bg-dark">
                <div class="card-body">
                    ...
                    <a href="/mca-15.html" class="btn btn-primary">Try Again</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card text-center text-white bg-dark">
                <div class="card-body">
                    <h5 class="card-title">"Foundation of Information Technology" completed??</h5>
                    <a href="/mca1.jsp" class="btn btn-primary">Select subject</a>
                </div>
            </div>
        </div>
    </div>

...
<body style="background-color: #DAE0E2;">
    ...
    <div class="container my-4">
        <nav class="navbar navbar-light bg-dark">
            ...
            <centre><a href="logout.jsp" class="btn btn-lg btn-primary btn-lg" type="submit">Logout</a></centre>
            <h3 class="text-white"><br>Username: <% out.println(request.getParameter("name")); %><br></h3>
        </nav>
    </div>
    <div class="container my-4">
        <form action="mca1.jsp" method="post">
            <label><b>Select your branch :</b></label>

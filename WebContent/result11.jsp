...
<body style="background-color: #DAE0E2;">
  ...
  <div class="container my-4">
    ...
    <center>
    <nav class="navbar navbar-light bg-dark">
      <a href="resultdis1.jsp" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Result</a>
    </nav>
    </center>
...
<div class="container my-4">
    ...
    <div class="alert alert-warning" role="alert">
        Congratulations!!!You scored <%out.println(request.getParameter("result")); %> % in your test
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="card text-center text-white bg-dark">
                <div class="card-body">
                    ...
                    <a href="mca-11.jsp" class="btn btn-primary">Try Again</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card text-center text-white bg-dark">
                <div class="card-body">
                    <h5 class="card-title">Ready for Unit-2???</h5>
                    <a href="mca-112.jsp" class="btn btn-primary">Unit-2</a>
                </div>
            </div>
        </div>
    </div>

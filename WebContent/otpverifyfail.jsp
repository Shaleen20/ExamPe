...
<body style="background-color: #DAE0E2;">
    ...
    <div class="container">
        ...
        <div class="alert alert-danger" role="alert">
            Oops!!Something went wrong..It seems that you have entered the wrong OTP!!
        </div>

        <a href="otp.jsp" class="btn btn-lg btn-primary btn-lg" type="submit">Go Back to enter OTP again</a>
